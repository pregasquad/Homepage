    ...
    >
      ...
      <div className="flex gap-8 mb-12">
        <motion.img
          ...
          className="w-32 h-32 md:w-48 md:h-48 rounded-full border-4 border-[#ff4500] shadow-[0_0_30px_rgba(255,69,0,0.3)]"
        />
        <motion.img
          src={womenLogo}
          initial={{ x: 50, opacity: 0, rotate: 10 }}
          ...
          className="w-32 h-32 md:w-48 md:h-48 rounded-full border-4 border-[#ff1493] shadow-[0_0_30px_rgba(255,20,147,0.3)]"
        />
      </div>
      ...
      <motion.h1
        ...
        className="text-[12vw] md:text-[8vw] font-bold tracking-tighter text-white font-display text-center leading-none"
      >
        PREGA<br />SQUAD
      </motion.h1>
      ...
      <motion.div
        ...
        className="w-48 h-1 bg-gradient-to-r from-[#ff4500] to-[#ff1493] mt-8 origin-center"
      />
    </motion.div>
  );
};
